    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            <?php foreach($assignments as $row){
                echo '<div class="line-rows"><a onclick="courseworkClick(this);" id="'.$row->assignment_id.'">'.$row->name.' - '.$row->course_id.' / '.$row->assignmentName.'</a></div><br>';
            }?>
        </div>
    </div>

    <form action="ltrSubmission" method="post" id="courseworkIds">
        <input type="hidden" id="courseworkId" name="assignmentId">
    </form>
