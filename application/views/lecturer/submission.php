...
<div class="mainDiv">
    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            <div class="line-rows"><a><?php if (isset($_SESSION['assignmentDetails'])){ echo $_SESSION['assignmentDetails'];}?></a></div>
            <div class="reservations">
                <table class="reservationTable">
                    <tr>
                        <th class="tableNew">Reg. No</th>
                        <th class="tableNew">Description</th>
                        <th class="tableNew">Document</th>
                        <th class="tableNew">Date</th>
                        <th class="tableNew">Time</th>
                    </tr>
                    <?php
                    foreach ($submission as $row){
                        echo '
                                <tr>
                                    <td class="tableNew">'.$row->regNum.'</td>
                                    <td class="tableNew">'.$row->description.'</td>
                                    <td class="tableNew"><img src="'.base_url().'siteimage/doc.png" style="width: 20px;cursor: pointer" id="'.base_url().$row->file.'" onclick="clickUrl(this)"></td>
                                    <td class="tableNew">'.$row->date.'</td>
                                    <td class="tableNew">'.$row->time.'</td>
                                </tr>
                    </tr>
                            ';
                    }
