...
<div class="mainDiv">
    ...
    <div class="container">
        <nav>
            <h1 class="brand"><a href="<?php echo base_url('LmsController/home'); ?>">A<span>BC</span> Institute <span> Lecturer Panel</span></a></h1>
            <ul>
    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            <img src="<?php if(!isset($_SESSION['imagePath'])||$_SESSION['imagePath']==null){echo base_url().'siteimage/user.png';}else{ echo base_url().base64_decode($_SESSION['imagePath']);} ?>" class="profileImage">
            <br><br><br><br>
            <h1>Hi <?php if (isset($_SESSION['userFirst'])){ echo $_SESSION['userFirst'];} ?>!!!</h1>
        </div>
    </div>
