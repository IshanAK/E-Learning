    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>UserController/register">REGISTRATION</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">LOGIN</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>UserController/login">Student</a>
                        <a class="dropdown-item" href="<?php echo base_url(); ?>UserController/login">Lecturer</a>
                        <a class="dropdown-item" href="<?php echo base_url(); ?>UserController/login">Admin</a>
                    </div>
                </li>
            </ul>
        </div>
